...
#set -euo pipefail
# ======================================================================================================================
# Scripts - Deploy - Dev - MacOS - Device - Deploy
# ======================================================================================================================
...
setPlatform() {
  ...
  #if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/macos/mac/network/_hosts.sh ]; then
  #  source "${PROJECT_PATH}"/scripts/deploy/dev/macos/mac/network/_hosts.sh
  #else
  #  echo "Please check a file : ./scripts/deploy/dev/macos/mac/network/_hosts.sh" && exit
  #fi
  #echo

  # >>>> MacOS - Packages

  #if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/macos/mac/packages/_base.sh ]; then
  #  source "${PROJECT_PATH}"/scripts/deploy/dev/macos/mac/packages/_base.sh
  #else
  #  echo "Please check a file : ./scripts/deploy/dev/macos/mac/packages/_base.sh" && exit
  #fi
  #echo

  # >>>> MacOS - Security

  #if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/macos/mac/security/_users.sh ]; then
  #  source "${PROJECT_PATH}"/scripts/deploy/dev/macos/mac/security/_users.sh
  #else
  #  echo "Please check a file : ./scripts/deploy/dev/macos/mac/security/_users.sh" && exit
  #fi
  #echo
