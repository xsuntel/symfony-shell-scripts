...
setPlatform() {
  echo "---------------------------------------------------------------------------------------------------------------"
  echo "[ ${ENVIRONMENT_NAME} ] ${PLATFORM_TYPE} - Platform : ${PLATFORM_TYPE}"
  echo "---------------------------------------------------------------------------------------------------------------"
  echo
  ...
  #if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/windows/x86-64/network/_hosts.sh ]; then
  #  source "${PROJECT_PATH}"/scripts/deploy/dev/windows/x86-64/network/_hosts.sh
  #else
  #  echo "Please check a file : ./scripts/deploy/dev/windows/x86-64/network/_hosts.sh" && exit
  #fi
  #echo

  # >>>> Windows - Packages

  #if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/windows/x86-64/packages/_base.sh ]; then
  #  source "${PROJECT_PATH}"/scripts/deploy/dev/windows/x86-64/packages/_base.sh
  #else
  #  echo "Please check a file : ./scripts/deploy/dev/windows/x86-64/packages/_base.sh" && exit
  #fi
  #echo

  # >>>> Windows - Security

  #if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/windows/x86-64/security/_users.sh ]; then
  #  source "${PROJECT_PATH}"/scripts/deploy/dev/windows/x86-64/security/_users.sh
  #else
  #  echo "Please check a file : ./scripts/deploy/dev/windows/x86-64/security/_users.sh" && exit
  #fi
  #echo
...
setTools() {
  echo "---------------------------------------------------------------------------------------------------------------"
  echo "[ ${ENVIRONMENT_NAME} ] ${PLATFORM_TYPE} - Tools - VM ( Instance ) : ${PLATFORM_TYPE}"
  echo "---------------------------------------------------------------------------------------------------------------"
  echo
